...
## Bugs 
- [x] Categoría principal permite volver a marcarse como principal, muestra mensaje y genera log innecesario. 
- [x] Productos por unidad permiten stock decimal.
- [x] Productos a granel no muestran/gestionan claramente kg/gr.
- [x] Al buscar dentro de una categoría, se muestran subcategorías vacías sin productos encontrados.
- [x] Se pueden agregar cantidades enormes de stock (1e+21)
